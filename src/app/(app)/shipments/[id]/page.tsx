...
export default async function ShipmentPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-6xl p-4 sm:p-6">
      <Link href="/shipments" className="text-sm font-medium text-ink-500 hover:text-ocean">← Your shipments</Link>
            ...
            {quote ? (
              <>
                <CardHeader
                  ...
                  title={<span className="num whitespace-nowrap font-sans text-base">{quote.reference}</span>}
